...
const HistorySection = () => {
    ...
    if (chainId !== contractChainId)
        return <div className="text-2xl text-gray-400 bg-gray-100 text-center py-6">Please switch to a Mumbai chain</div>
                    ...
                    <div key={i}>
                        <p className="font-semibold">
                            ...
                            <small className="text-gray-500 ml-2">
                                ({weiToMatic(lotteryHistory[1][i].toNumber())} MATIC)
                            </small>
                        </p>
            ...
            <ul>
                {
                    myTickets.map((ticket, i) => (
                        <div key={i}  className="text-white text-center bg-gray-800 py-3 my-3 rounded-md">
            ...
            <div className="container mx-auto flex px-8 md:px-16 md:flex-row flex-col-reverse">
                <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-3 md:text-left mb-16 md:mb-0 items-center text-center">
                    ...
                    <div  className="w-full mb-4 py-2">
                        <h3 className="whitespace-pre-line text-5xl text-purple-700 leading-normal tracking-normal font-bold">Lottery History</h3>
                    </div>
                    <WinnersHistory />
                    <div  className="flex flex-col md:flex-row justify-center md:justify-start py-4">
                        ...
                        >
                            ...
                            <span className="align-middle">Check in Explorer</span>
                        </a>
                    </div>
                </div>
